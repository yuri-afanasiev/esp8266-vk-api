...
if ($ri == '30') {
      ...
      $url_30='https://api.vk.com/method/wall.getById?posts='. $id.'&v=5.68';
 ...
 if ($ri == '31') {
    ...
    $url_31 ='https://api.vk.com/method/likes.getList?type='. $type.'&owner_id='. $owner_id.'&item_id='. $item_id. '&count=2&v=5.68';
 ...
 if ($ri == '32') {
      ...
      $url_32='https://api.vk.com/method/groups.getMembers?group_id='. $group_id.'&count=1&v=5.37';
